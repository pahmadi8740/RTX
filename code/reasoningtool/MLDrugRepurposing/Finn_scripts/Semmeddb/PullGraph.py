...
class PullGraph():
    ...
    def pull_drugs(self):
        ...
        """
        res = self.neo4j_run_cypher_query("match (n:chemical_substance) with distinct n.id as id, n.name as name return id, name union match (n:drug) with distinct n.id as id, n.name as name return id, name")
        df = pd.DataFrame(res.data())
        return df
...
if __name__ == '__main__':
    ...
    pg = PullGraph(args.user, args.password, args.url)
