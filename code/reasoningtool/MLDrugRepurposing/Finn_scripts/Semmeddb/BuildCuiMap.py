...
sys.path.append("/home/finn/Documents/rtx_clone/RTX/code/ARAX/ARAXQuery/Expand/")
sys.path.append("/home/finn/Documents/rtx_clone/RTX/code/ARAX/ARAXQuery/")

from expand_utilities import get_curie_synonyms
...
def convert_id(un_id):
    if un_id.startswith('UMLS') or un_id.startswith('CUI'):
        return None
    id_list = get_curie_synonyms(un_id, r)
    #print(id_list)
    for conv_id in id_list:
        if conv_id.startswith('UMLS') or conv_id.startswith('CUI'):
            #print(conv_id)
